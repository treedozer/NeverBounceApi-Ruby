	...
	class API
		...
		def request(endpoint, params)
			...
			if response['success'] === false
				...
				raise RequestError, 'We were unable to complete your request. The following information was supplied: ' +
		...
		def get_access_token
			...
			if response['error'] != nil
				raise AuthError,	'We were unable to complete your request. The following information was supplied: ' +
